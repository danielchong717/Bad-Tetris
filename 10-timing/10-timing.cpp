...
bool init()
{
    ...
    else
    {
        ...
        if( SDL_CreateWindowAndRenderer( "SDL3 Tutorial: Timing", kScreenWidth, kScreenHeight, 0, &gWindow, &gRenderer ) == false )
        {
...
bool loadMedia()
{
    ...
    else
    {
        ...
        if( !gTimeTextTexture.loadFromRenderedText( "Press enter to start the timer", textColor ) )
        {
